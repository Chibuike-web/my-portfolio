...
// 					className={cn(
// 						"flex overflow-hidden rounded-[0.5rem] md:rounded-[1rem] bg-surface-muted ring ring-surface-hover",
// 						isZoomed && "opacity-0",
// 						className,
// 					)}
// 				>
...
// 						loading="lazy"
// 						placeholder="blur"
// 						onLoad={() => setIsInlineLoaded(true)}
// 						className={cn(
// 							"h-auto w-full transition duration-500 ease-out",
// 							isInlineLoaded ? "scale-100 blur-0" : "scale-[1.02] blur-xl",
// 						)}
// 					/>
// 				</motion.div>
// 			</motion.button>
...
// 								layoutId={layoutId}
// 								transition={{ type: "spring", duration: 0.2, bounce: 0 }}
// 								className="flex max-w-[1000px] overflow-hidden rounded-[0.5rem] md:rounded-[1rem] bg-surface-muted ring ring-surface-hover"
// 							>
// 								<Image
// 									src={src}
// 									alt={alt}
