    ...
    <main className="mx-auto w-full max-w-[81rem] px-6 xl:px-0">
      <nav className="flex w-full items-center justify-between py-8 text-sm md:text-base">
        <header className="flex flex-col gap-2.5">
          ...
          <p className="font-secondary font-semibold text-gray-500">LESS BURNOUT, MORE PRODUCTIVITY</p>
        </header>
      ...
      <section className="flex flex-col gap-6 md:flex-row">
        ...
        <div className="grid max-w-[53.5rem] grid-cols-1 gap-6 sm:grid-cols-2">
          <p className="w-full text-sm leading-[1.6] font-medium text-gray-500 md:text-base">
            ...
            difficulty of the work they have done so far.
          </p>
          <p className="w-full text-sm leading-[1.6] font-medium text-gray-500 md:text-base">
            We worked on a team of three and alternated leadership positions every week. I worked
            on the admin part of the product.
          </p>
          ...
          <div className="flex w-full flex-col gap-1">
            ...
            <p className="w-full text-sm leading-[1.6] font-medium text-gray-500 md:text-base">
              I designed the admin side of Zenly&apos;s burnout management dashboard. Admins can create,
              edit, and delete teams, assign team leads, and configure burnout limits for each
              group.
            </p>
          </div>
          <div className="flex w-full items-start gap-4">
            ...
            <div className="flex w-full flex-col gap-1">
              ...
              <p className="w-full text-sm leading-[1.6] font-medium text-gray-500 md:text-base">1 month</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-[3.25rem] md:mt-[6.5rem]">
        <LazyImage src={firstImage} alt="Image showing a single dashboard" className="rounded-[1rem] ring-1 ring-black/5 md:rounded-[2rem]" />
      </section>
      ...
      <section className="mt-[3.25rem] md:mt-[6.5rem]">
        ...
        <LazyImage src={secondImage} alt="Image showing two team creation screens with modals" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
        <LazyImage src={thirdImage} alt="Image showing two team creation screens with supporting states" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
      </section>
      ...
      <section className="mt-[3.25rem] md:mt-[6.5rem]">
        ...
        <LazyImage src={fourthImage} alt="Image showing two edit team screens with modals" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
        <LazyImage src={fifthImage} alt="Image showing detailed team edit screens" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
        <LazyImage src={sixthImage} alt="Image showing a single team edit screen" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
      </section>
      ...
      <section className="mt-[3.25rem] md:mt-[6.5rem]">
        ...
        <LazyImage src={seventhImage} alt="Image showing a single team lead assignment screen" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
        <LazyImage src={eighthImage} alt="Image showing two team lead assignment screens with modals" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
      </section>
      ...
      <section className="mt-[3.25rem] md:mt-[6.5rem]">
        ...
        <LazyImage src={ninthImage} alt="Image showing a single manage team member screen" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
        <LazyImage src={tenthImage} alt="Image showing another team management screen" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
        <LazyImage src={eleventhImage} alt="Image showing a manage team member screen with modal" className="mt-6 rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:rounded-[2rem]" />
        <LazyImage src={twelfthImage} alt="Image showing the final team management screen" className="mt-6 mb-[3.25rem] rounded-[1rem] ring-1 ring-black/5 md:mt-12 md:mb-[6.5rem] md:rounded-[2rem]" />
      </section>
    </main>
  );
}
