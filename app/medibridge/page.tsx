	...
	return (
		<main className="mx-auto w-full max-w-[81rem] px-6 xl:px-0">
			...
			<section className="mt-[3.25rem] flex flex-col gap-6 md:mt-[6.5rem] md:gap-12">
				...
				<LazyImage
					src={fifthImage}
					alt="Image showing uploaded patient document states"
					className="rounded-[1rem] ring-1 ring-black/5 md:rounded-[2rem]"
				/>
				<LazyImage
					src={sixthImage}
					alt="Image showing extracted patient data for review"
					className="rounded-[1rem] ring-1 ring-black/5 md:rounded-[2rem]"
				/>
				<LazyImage
					src={seventhImage}
					alt="Image showing patient profile confirmation flow"
					className="rounded-[1rem] ring-1 ring-black/5 md:rounded-[2rem]"
				/>
			</section>
			...
			<section className="mt-[3.25rem] flex flex-col gap-6 md:mt-[6.5rem] md:gap-12">
				...
				<LazyImage
					src={eighthImage}
					alt="Image showing a filled dashboard screen with Patient Records active"
					className="rounded-[1rem] ring-1 ring-black/5 md:rounded-[2rem]"
				/>
				<LazyImage
					src={ninthImage}
					alt="Image showing a filled dashboard screen with Transfers active"
					className="rounded-[1rem] ring-1 ring-black/5 md:rounded-[2rem]"
				/>
				<LazyImage
					src={tenthImage}
					alt="Image showing two transfer modals with patient selection states"
					className="rounded-[1rem] ring-1 ring-black/5 md:rounded-[2rem]"
				/>
			</section>
