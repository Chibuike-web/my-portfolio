    ...
    <main className="mx-auto w-full max-w-[81rem] px-6 xl:px-0">
        ...
        <div className="grid max-w-[53.5rem] grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="flex w-full items-start gap-4">
            ...
            <div className="flex w-full flex-col gap-1">
              ...
              <p className="w-full text-sm leading-[1.6] font-medium text-gray-500 md:text-base">2 months</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-[3.25rem] md:mt-[6.5rem]">
        <p className="mb-6 w-full max-w-[53.4375rem] text-sm leading-[1.6] font-medium text-gray-500 md:mb-12 md:text-base">
          Unfortunately, the entire team was let go, and as a result, much of my work was
          ultimately shelved. Below are some of my contributions to the entire mobile app redesign.
        </p>
        <LazyImage
          src={ninthImage}
